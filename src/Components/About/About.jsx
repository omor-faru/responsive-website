            ...
            <div className="flex gap-3 py-4">
              ...
              <span className="w-96 ">
                ...
                <p className="text-xl md:text-md leading-tight">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere obcaecati debitis dolore inventore tempora sed odit nulla totam voluptas eaque beatae ad, doloribus consequuntur ab!</p>
              </span>
            </div>
            <div className="flex gap-3 py-4">
              <IoArrowForward size={30} className="mt-1"/>
